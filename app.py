...
# Verifica o crea los CSV si no existen
INVENTARIO_FILE = "inventario.csv"
HISTORIAL_FILE = "historial.csv"

for archivo, columnas in [
    (INVENTARIO_FILE, ["producto", "stock", "bodega", "piezas_fardo"]),
    (HISTORIAL_FILE, ["fecha", "producto", "movimiento", "cantidad", "bodega", "nota"])
]:
...
if busqueda:
    inventario_filtrado = inventario_filtrado[inventario_filtrado["producto"].str.contains(busqueda, case=False)]
